...
def heuristic4(node, objectives):  # distancia entre las cajas y sus objetivos mas cercanos (creo euclidiana en minima distancia global)
    curr_heuristic = 0
    for box in node.boxes:
...
def heuristic5(node, objectives): # distancia entre las cajas y sus objetivos mas cercanos (creo euclidiana sin el cuadrado en minima distancia global)
    curr_heuristic = 0
    for box in node.boxes:
        min_distance_to_obj = math.inf
        for objective in objectives:
